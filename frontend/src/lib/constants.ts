...
export const SITE_CONTENT = {
  ...
  about: {
    ...
    story:
      'המניעה נוסדה מתוך צורך אמיתי ואתי — למצוא פתרון השמה שמכיר את הציבור החרדי, את ערכיו צרכיו מיוחדים. אנחנו לא מכונה אוטומטית. כל מועמד מקבל טיפול סדור, כל משרה עוברת בדיקה קפדנית, וכל גיוס מלווה ע"י אנשים אמיתיים שמים את השוק.',
    values: [
      {
        title: "פרטיות",
        desc: "קשר פרטי נשמרים אצלנו — שום קשר ישיר ללא אישור",
      },
