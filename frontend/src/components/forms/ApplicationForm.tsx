    ...
    <div className="bg-white border border-neutral-200 rounded-lg p-6 shadow-md">
      ...
      {submitted && (
        <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
          <p className="text-green-700 font-medium text-sm">{SITE_CONTENT.messages.success.candidate}</p>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          ...
          {errors.region && <p className="text-red-600 text-xs mt-1">{errors.region.message}</p>}
        </div>
