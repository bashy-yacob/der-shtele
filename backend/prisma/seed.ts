...
async function main() {
  ...
  const jobs: Prisma.JobUncheckedCreateInput[] = [
    ...
    },
    {
      ...
      title: "איש מחסן",
      descriptionPublic:
        "חברה במרכז הארץ מחפשת עובד מחסן חרוץ לליקוט, סידור וקבלת סחורה. אווירת עבודה נעימה ושעות נוחות. ניסיון יתרון, לא חובה.",
    ...
    },
    {
      ...
      title: "רכז תפעול",
      descriptionPublic:
        "דרוש רכז תפעול לתיאום בין מחלקות, מעקב אחר הזמנות ועבודה מול ספקים. תפקיד מגוון בסביבה מסודרת. היקף משרה גמיש.",
    ...
    // --- מעסיק B: משרד עורכי דין ---
    {
      ...
      title: "מזכיר / פקיד קבלה",
      descriptionPublic:
        "משרד עורכי דין בירושלים מחפש מזכיר מסודר ואדיב. היקף משרה גמיש, ניסיון במשרד יתרון.",
    ...
    },
    {
      ...
      title: "עוזר משפטי",
      descriptionPublic:
        "משרד עורכי דין בירושלים מחפש עוזר משפטי לניהול תיקים, הכנת מסמכים ותיאום פגישות. תפקיד מקצועי עם אפשרות להתפתחות. ניסיון בתחום המשפטי יתרון.",
  ...
  await ensureJob({
    ...
    title: "נהג חלוקה",
    descriptionPublic:
      "חברת לוגיסטיקה מחפשת נהג חלוקה אחראי לאזור המרכז. שעות נוחות, תנאים טובים ואווירה משפחתית.",
